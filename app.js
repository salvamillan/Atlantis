...
// ================= NORMALIZADOR (ORDERS) =================
// Tu endpoint devuelve: idcliente, fechadecompra (DD/MM/YYYY), estado, ordernumber (number), idarticulo (string)
// Normalizamos a los nombres que usa el renderer de la tabla.
function normalizeOrderRow(raw) {
  return {
    ...
    // El importe NO viene en orders: lo resolvemos con books.precio vía getFormattedPriceForArticle()
    importe: null,
  };
}
